        ...
        if (match != null  ) {
            ...
            if(match.lineup != null && match.lineup.data.size > 0){
                ...
                if(match.formations != null){
                    ...
                    view?.setLineupHome(home11, homebench, SMTeamShort.getTeamShort(match.localTeam?.data?.name), homeformation)
                    view?.setLineupAway(away11,awaybench, SMTeamShort.getTeamShort(match.visitorTeam?.data?.name), awayformation)
