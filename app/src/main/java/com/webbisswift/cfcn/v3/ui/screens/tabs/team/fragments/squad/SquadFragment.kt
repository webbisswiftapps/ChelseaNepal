...
class SquadFragment:BaseFragment(), SquadContract.SquadView{
    ...
    override fun addCoach(coach: SMCoach) {
        val coachItem = SquadItem(SquadAdapterConstants.TYPE_COACH, null, null, coach, null, null, null, null)
    ...
    override fun addSquadGroup(title: String, players: List<SMSquad.SMSquadItem>) {
        val titleItem = SquadItem(SquadAdapterConstants.TYPE_TITLE, title, null, null, null , null , null, null)
        this.rvAdapter.addSquadItem(titleItem)

        for(player in players) {
            val playerItem = SquadItem(SquadAdapterConstants.TYPE_SQUAD_PLAYER, null, player, null, null , null , null, null)
