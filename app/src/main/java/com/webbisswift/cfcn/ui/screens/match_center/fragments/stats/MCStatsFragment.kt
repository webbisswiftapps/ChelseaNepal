...
import kotlinx.android.synthetic.main.layout_match_stats_fragment.*
...
class MCStatsFragment: BaseFragment(),  MCStatsContract.MCStatsView{
    ...
    override fun showMatchStatsUnavailable() {
        if(lineupMainSwitcher.currentView.id == R.id.statsMain) statsMainSwitcher.showPrevious()
        lineupsErr.text = "Match Stats unavailable for this match."
    }
